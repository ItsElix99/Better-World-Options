...
public class Alpha112_ChunkGenerator implements ChunkSource {
    ...
    public Alpha112_ChunkGenerator(World world, long seed) {
        this.world = world;
                        ...
                        for(int var41 = 0; var41 < 4; ++var41) {
                            ...
                            for(int var50 = 0; var50 < 4; ++var50) {
                                ...
                                if(var11 * 8 + var30 < var5) {
                                    if(var52 < 0.5D && var11 * 8 + var30 >= var5 - 1) {
                                        var51 = Block.ICE.id;
                                    } else {
    ...
    public void buildSurfaces(int chunkX, int chunkZ, byte[] blocks) {
        ...
        for(int var7 = 0; var7 < 16; ++var7) {
            for(int var8 = 0; var8 < 16; ++var8) {
                ...
                int var12 = -1;
                byte var13 = (byte)Block.GRASS_BLOCK.id;
    ...
    public Chunk getChunk(int chunkX, int chunkZ) {
        ...
        this.buildSurfaces(chunkX, chunkZ, var3);
