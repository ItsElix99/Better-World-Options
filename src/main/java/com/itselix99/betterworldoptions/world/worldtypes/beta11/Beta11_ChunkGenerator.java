package com.itselix99.betterworldoptions.world.worldtypes.beta11;
...
public class Beta11_ChunkGenerator implements ChunkSource {
    ...
    public Beta11_ChunkGenerator(World world, long seed) {
        this.world = world;
