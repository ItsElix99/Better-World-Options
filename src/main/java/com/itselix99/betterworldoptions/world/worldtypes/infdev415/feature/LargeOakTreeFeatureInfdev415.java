package com.itselix99.betterworldoptions.world.worldtypes.infdev415.feature;
...
public final class LargeOakTreeFeatureInfdev415 extends Feature {
    ...
    private void placeBlockLine(int[] var1, int[] var2, int var3) {
        ...
        if (var15[var5] != 0) {
            ...
            for (var3 = var15[var5] + var6; var8 != var3; var8 += var6) {
                ...
                this.worldObj.setBlockWithoutNotifyingNeighbors(var7[0], var7[1], var7[2], 17);
            }
    ...
    public boolean generate(World var1, Random var2, int var3, int var4, int var5) {
        ...
        if (!var10000) {
            ...
            LargeOakTreeFeatureInfdev415 var38 = this;
                ...
                if (var9 < 0.0F) {
                    ...
                    for (; var8 < var40; ++var8) {
                        ...
                        if (var38.checkBlockLine(var12, var52) == -1) {
                            ...
                            double var28 = Math.sqrt(Math.pow(Math.abs(var38.basePos[0] - var12[0]), 2.0D) + Math.pow(Math.abs(var38.basePos[2] - var12[2]), 2.0D));
            ...
            for (var3 = this.leafNodes.length; var40 < var3; ++var40) {
                ...
                int var49 = var5;
                var8 = var10001;
                LargeOakTreeFeatureInfdev415 var47 = var38;
                var5 = var5;
                ...
                for (int var56 = var49 + var38.leafDistanceLimit; var5 < var56; ++var5) {
                    ...
                    var53 = true;
                    float var51 = var20;
                    LargeOakTreeFeatureInfdev415 var57 = var47;
                            ...
                            while (true) {
                                ...
                                if (var60 > (double) var51) {
                                    ...
                                    if (var54 != 0 && var54 != 18) {
                                        ...
                                        var57.worldObj.setBlockWithoutNotifyingNeighbors(var50[0], var50[1], var50[2], 18);
                                        ++var55;
                                    }
                                }
                            }
