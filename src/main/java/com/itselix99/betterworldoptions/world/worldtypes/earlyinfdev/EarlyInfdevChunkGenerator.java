...
public class EarlyInfdevChunkGenerator implements ChunkSource {
            ...
            for (int var7 = chunkZ; var7 < chunkZ + 16; ++var7) {
                ...
                for (int var14 = 0; var14 < 128; ++var14) {
                    ...
                    if ((var6 == 0 || var7 == 0) && var14 <= var13 + 2) {
                        ...
                        if (var19 < 0.2F && var18 > 0.95F && ((BWOProperties) this.world.getProperties()).bwo_getBetaFeatures()) {
                             var15 = Block.SAND.id;
                        } else {
                        ...
                        if (var18 < 0.5D && var14 >= 63 && ((BWOProperties) this.world.getProperties()).bwo_getBetaFeatures()) {
                            var15 = Block.ICE.id;
                        } else {
    ...
    public void decorate(ChunkSource source, int x, int z) {
        if (!((BWOProperties) this.world.getProperties()).bwo_getBetaFeatures()) {
            ...
            int var37 = (int) ((this.forestNoise.create((double) var4 * (1.0D / 16.0D), (double) x * (1.0D / 16.0D) * 4.0D, (double) var4 * (1.0D / 16.0D)) + (double) (128 - x) / 64.0D));
            int var49 = 0;
