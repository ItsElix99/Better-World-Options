...
public class EarlyInfdevChunkGenerator implements ChunkSource {
    ...
    private final OctavePerlinNoiseSamplerEarlyInfdev forestNoise;
    ...
    public void buildTerrain(int chunkX, int chunkZ, byte[] blocks, double[] temperatures) {
        ...
        for (int var6 = blockX; var6 < blockX + 16; ++var6) {
            for (int var7 = blockZ; var7 < blockZ + 16; ++var7) {
                int var8 = var6 / 1024;
                int var9 = var7 / 1024;
                ...
                for (int var14 = 0; var14 < 128; ++var14) {
                    ...
                    double var18 = temperatures[(var6 - blockX) * 16 + var7 - blockZ];
                    int var15 = 0;
                    ...
                    this.random.setSeed(var8 + var9 * 13871L);
                    int var16 = (var8 << 10) + 128 + this.random.nextInt(512);
                    int var17 = (var9 << 10) + 128 + this.random.nextInt(512);
    ...
    public void decorate(ChunkSource source, int x, int z) {
        ...
        int var37 = (int)((this.forestNoise.create((double)var4 * (1.0D / 16.0D), (double)z * (1.0D / 16.0D) * 4.0D, (double)x * (1.0D / 16.0D)) + (double)(128 - z) / 64.0D));
        int var49 = 0;
