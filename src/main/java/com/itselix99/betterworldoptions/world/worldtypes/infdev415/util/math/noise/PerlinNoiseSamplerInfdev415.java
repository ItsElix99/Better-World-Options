...
public class PerlinNoiseSamplerInfdev415 extends NoiseSampler {
    ...
    public double sample(double x, double y, double z) {
        ...
        int var22 = MathHelper.floor(var7) & 255;
        int var2 = MathHelper.floor(var9) & 255;
        int var23 = MathHelper.floor(var11) & 255;
        var7 -= (double) MathHelper.floor(var7);
        var9 -= (double) MathHelper.floor(var9);
        var11 -= (double) MathHelper.floor(var11);
