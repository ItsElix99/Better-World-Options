...
public class Infdev420ChunkGenerator implements ChunkSource {
    ...
    public void buildTerrain(int chunkX, int chunkZ, byte[] blocks, double[] temperatures) {
                    ...
                    for(int var24 = 0; var24 < 8; ++var24) {
                        ...
                        for(int var82 = 0; var82 < 4; ++var82) {
                            ...
                            for(int var35 = 0; var35 < 4; ++var35) {
                                ...
                                int var83 = 0;
                                if((var7 << 3) + var24 < 64) {
                                    if (var53 < (double)0.5F && var7 * 8 + var24 >= 63) {
                                        var83 = Block.ICE.id;
                                    } else {
        ...
        for(var72 = 0; var72 < 16; ++var72) {
            for(var73 = 0; var73 < 16; ++var73) {
                ...
                int var17 = -1;
                int var80 = Block.GRASS_BLOCK.id;
    ...
    public void decorate(ChunkSource source, int x, int z) {
        ...
        int var37 = (int)(this.forestNoise.sample((double)var4 * 0.05D, (double)var5 * 0.05D) - this.random.nextDouble());
        int var49 = 0;
