                    ...
                    for(int var24 = 0; var24 < 8; ++var24) {
                        ...
                        for(int var82 = 0; var82 < 4; ++var82) {
                            ...
                            for(int var35 = 0; var35 < 4; ++var35) {
                                ...
                                int var83 = 0;
                                if((var7 << 3) + var24 < 64) {
                                    if (var53 < (double)0.5F && var7 * 8 + var24 >= 63 && ((BWOProperties) this.world.getProperties()).bwo_getBetaFeatures()) {
                                        var83 = Block.ICE.id;
                                    } else {
                ...
                for(int var81 = 127; var81 >= 0; --var81) {
                    if(blocks[var79] == 0) {
                        ...
                        if(var17 == -1) {
                            ...
                            --var17;
                            blocks[var79] = (byte)var19;
                            if (var17 == 0 && var19 == Block.SAND.id && ((BWOProperties) this.world.getProperties()).bwo_getBetaFeatures()) {
    ...
    public void decorate(ChunkSource source, int x, int z) {
        if (!((BWOProperties) this.world.getProperties()).bwo_getBetaFeatures()) {
            ...
            for(z = 0; z < 20; ++z) {
                ...
                (new OreFeatureInfdev420(Block.COAL_ORE.id)).generate(this.world, this.random, var5, var6, var7);
            }
            ...
            for(z = 0; z < 10; ++z) {
                ...
                var7 = x + this.random.nextInt(16);
                (new OreFeatureInfdev420(Block.IRON_ORE.id)).generate(this.world, this.random, var5, var6, var7);
            }
            ...
            if(this.random.nextInt(2) == 0) {
                ...
                (new OreFeatureInfdev420(Block.GOLD_ORE.id)).generate(this.world, this.random, z, var5, var6);
            }
            ...
            if(this.random.nextInt(8) == 0) {
                ...
                var6 = x + this.random.nextInt(16);
                (new OreFeatureInfdev420(Block.DIAMOND_ORE.id)).generate(this.world, this.random, z, var5, var6);
            }
            ...
            int var37 = (int) (this.forestNoise.sample((double) var4 * 0.05D, (double) x * 0.05D) - this.random.nextDouble());
            int var49 = 0;
