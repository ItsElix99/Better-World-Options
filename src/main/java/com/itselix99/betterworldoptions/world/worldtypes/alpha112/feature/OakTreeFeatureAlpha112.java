package com.itselix99.betterworldoptions.world.worldtypes.alpha112.feature;
...
public class OakTreeFeatureAlpha112 extends Feature {
    public boolean generate(World world, Random random, int x, int y, int z) {
        ...
        if (y >= 1 && y + var6 + 1 <= 128) {
                ...
                for(int var10 = x - var9; var10 <= x + var9 && var7; ++var10) {
                    for(int var11 = z - var9; var11 <= z + var9 && var7; ++var11) {
                        if (var8 >= 0 && var8 < 128) {
                            ...
                            if (var12 != 0 && var12 != BetterWorldOptions.ALPHA_LEAVES.id) {
                                var7 = false;
                            }
                        } else {
                            var7 = false;
            ...
            if (!var7) {
                ...
                if ((var16 == Block.GRASS_BLOCK.id || var16 == Block.DIRT.id) && y < 128 - var6 - 1) {
                    ...
                    for(int var18 = 0; var18 < var6; ++var18) {
                        ...
                        if (var20 == 0 || var20 == BetterWorldOptions.ALPHA_LEAVES.id) {
