    ...
    public void decorate(ChunkSource source, int x, int z) {
        ...
        for(int var96 = var4 + 8; var96 < var4 + 8 + 16; ++var96) {
            for(int var107 = var5 + 8; var107 < var5 + 8 + 16; ++var107) {
                ...
                if (!this.theme.isHot() && var23 < (double)temp && var22 > 0 && var22 < this.world.dimension.getHeight() && this.world.getBlockId(var96, var22, var107) == 0 && this.world.getMaterial(var96, var22 - 1, var107).blocksMovement() && this.world.getMaterial(var96, var22 - 1, var107) != Material.ICE) {
