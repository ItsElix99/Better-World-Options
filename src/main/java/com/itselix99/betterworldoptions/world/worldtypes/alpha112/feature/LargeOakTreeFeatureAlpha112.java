...
public class LargeOakTreeFeatureAlpha112 extends Feature {
    ...
    void placeFoliageCluster(int x, int baseY, int z) {
        ...
        for(int var5 = baseY + this.foliageClusterHeight; var4 < var5; ++var4) {
            ...
            this.placeCluster(x, var4, z, var6, (byte)1, BetterWorldOptions.ALPHA_LEAVES.id);
        }
    ...
    int tryBranch(int[] from, int[] to) {
        ...
        if (var3[var5] == 0) {
            ...
            for(var15 = var3[var5] + var8; var14 != var15; var14 += var8) {
                ...
                if (var16 != 0 && var16 != BetterWorldOptions.ALPHA_LEAVES.id) {
                    break;
                }
            }
    ...
    boolean canPlace() {
        ...
        if (var3 != Block.GRASS_BLOCK.id && var3 != 3) {
            return false;
        } else {
