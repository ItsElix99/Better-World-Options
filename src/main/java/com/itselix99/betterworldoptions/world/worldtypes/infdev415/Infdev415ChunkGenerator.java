...
public class Infdev415ChunkGenerator implements ChunkSource {
    ...
    public void buildTerrain(int chunkX, int chunkZ, byte[] blocks, double[] temperatures) {
                    ...
                    for(int var25 = 0; var25 < 4; ++var25) {
                        ...
                        for(int var55 = 0; var55 < 4; ++var55) {
                            ...
                            for(int var36 = 0; var36 < 4; ++var36) {
                                ...
                                int var56 = 0;
                                if((var8 << 2) + var25 < 64) {
                                    if (var53 < (double)0.5F && var8 * 8 + var25 >= 63) {
                                        var56 = Block.ICE.id;
                                    } else {
        ...
        for(var5 = 0; var5 < 16; ++var5) {
            for(var6 = 0; var6 < 16; ++var6) {
                ...
                var50 = (chunkZ << 4) + var6;
                boolean var51 = this.noiseGen4.create(var49 * (1.0 / 32.0), var50 * (1.0 / 32.0), 0.0)[0] + this.random.nextDouble() * 0.2D > 0.0;
                boolean var14 = this.noiseGen4.create(var50 * (1.0 / 32.0), 109.0134D, var49 * (1.0 / 32.0))[0] + this.random.nextDouble() * 0.2D > 0.0;
                ...
                int var53 = -1;
                int var18 = Block.GRASS_BLOCK.id;
                int var54 = Block.DIRT.id;
    ...
    private double generateHeightMap(double var1, double var3, double var5) {
        ...
        double var9 = this.noiseGen3.create(var1 * 684.412D / 80.0D, var3 * 684.412D / 400.0D, var5 * 684.412D / 80.0D)[0] / 2.0D;
        double var11;
        double var13;
        if(var9 < -1.0D) {
            var11 = this.noiseGen1.create(var1 * 684.412D, var3 * 984.412D, var5 * 684.412D)[0] / 512.0D;
            var13 = var11 - var7;
            if(var13 < -10.0D) {
                var13 = -10.0D;
            }
            ...
            var11 = this.noiseGen2.create(var1 * 684.412D, var3 * 984.412D, var5 * 684.412D)[0] / 512.0D;
            var13 = var11 - var7;
            if(var13 < -10.0D) {
                var13 = -10.0D;
            }
            ...
            double var15 = this.noiseGen1.create(var1 * 684.412D, var3 * 984.412D, var5 * 684.412D)[0] / 512.0D - var7;
            double var17 = this.noiseGen2.create(var1 * 684.412D, var3 * 984.412D, var5 * 684.412D)[0] / 512.0D - var7;
            if(var15 < -10.0D) {
                var15 = -10.0D;
            }
    ...
    public void decorate(ChunkSource source, int x, int z) {
        ...
        int var37 = (int)this.forestNoise.sample((double)var4 * 0.25D, (double)var5 * 0.25D) << 3;
        int var49 = 0;
