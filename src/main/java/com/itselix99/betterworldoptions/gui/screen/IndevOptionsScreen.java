...
public class IndevOptionsScreen extends Screen {
    ...
    public void init() {
        ...
        this.buttons.add(this.sizeButton = new ButtonWidget(3, this.width / 2 - 155, this.height / 4 + 48, 310, 20, this.translation.get("indevOptions.size") + " " + this.worldGenerationOptions.size + " " + this.worldGenerationOptions.worldSizeX + "x" + this.worldGenerationOptions.worldSizeZ));
        this.buttons.add(new ButtonWidget(4, this.width / 2 - 155, this.height / 4 + 72, 310, 20, this.translation.get("indevOptions.indevHouse") + " " + (this.worldGenerationOptions.generateIndevHouse ? this.translation.get("options.on") : this.translation.get("options.off"))));
        this.buttons.add(this.infiniteWorldButton = new ButtonWidget(5, this.width / 2 - 155, this.height / 4 + 96, 310, 20, this.translation.get("indevOptions.infiniteWorld") + " " + (this.worldGenerationOptions.infiniteWorld ? this.translation.get("options.on") : this.translation.get("options.off"))));
        this.buttons.add(new ButtonWidget(6, this.width / 2 - 100, this.height / 6 + 168, this.translation.get("gui.done")));
    }
